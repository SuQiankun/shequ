...
//					+username+':'
				...
				+'<button type="button" class="mui-btn mui-btn-primary mui-btn-outlined"  id="'
				+data.data[i].peo_id
				+'" onclick="changePersonInfo(this.id)">修改</button>&nbsp;&nbsp&nbsp;&nbsp;'
				+'<button type="button" class="mui-btn mui-btn-danger"  id="'
				+data.data[i].peo_id
				+'"'
				+'value = "'
				+name
				+'"'
				+'onclick="deletePersonInfo(this.id,this.value)">删除</button>&nbsp;&nbsp;</div></div></div>'
				;
			}
